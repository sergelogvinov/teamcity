...
`agent.securityContext` | Custom [security context](https://kubernetes.io/docs/tasks/configure-pod-container/security-context/) for Teamcity agent containers | `{runAsUser: 1000, runAsGroup: 1000}` |
